...
uicontrol('Tag','functionButtonGroup_function6_pushbutton',...
    ...
    'String','MFE',...
    'TooltipString',sprintf('%s\n%s',...
    'Calculate MFE and its statistics',...
    '(new window, F6)'),...
...
uicontrol('Tag','status_panel_status_desctext',...
    ...
    'String',{'Status:'},...
    'Enable','Inactive',...
    'ButtonDownFcn',@TAgui_statuswindow ...
    );
...
try
    ...
    splash = imread(fullfile(path,'private','splashes','TAtoolboxSplash.png'),'png');
    image(splash);
...
% Parse directory strings using "TAparseDir"
for k=1:length(dirs)
    ad.control.dirs.(dirs{k}) = TAparseDir(ad.control.dirs.(dirs{k}));
end
