function varargout = TAguiDataStructure(varargin)
% TAGUIDATASTRUCTURE Return data structure for TA toolbox data, or test
% compliance of given structure with the data structure of the toolbox.
%
% Usage
%   structure = TAguiDataStructure;
%   structure = TAguiDataStructure(<command>)
%   [missingFields,wrongType] = TAguiDataStructure(<command>,structure)
%
%   <command> - string 
...
% Create GUI-specific fields to data model
