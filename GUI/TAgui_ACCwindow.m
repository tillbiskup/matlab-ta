        ...
        switch action
            ...
            case 'accumulationmethod'
                ...
                switch accumulationMethod
                    case 'weighted'
                        set(gh.accumulation_panel_weights_min_edit,...
                            'Enable','On');
                        set(gh.accumulation_panel_weights_max_edit,...
                            'Enable','On');
                    otherwise
                        set(gh.accumulation_panel_weights_min_edit,...
                            'Enable','Off');
        ...
        switch panel
            ...
            case 'Results'
                if isempty(ad.acc.data)
                    ...
                    if ydim > 1
                        set(gh.accumulate_panel_dimensions_step_y_edit,...
                            'String',...
...
function updateAxes()
    try
        ...
        set(gh.data_panel_showonlyactive_checkbox,'Value',...
