...
uicontrol('Tag','data_panel_add_pushbutton',...
    ...
    'Units','Pixels',...
    'Position',[10 mainPanelHeight-155 60 35],...
...
uicontrol('Tag','data_panel_remove_pushbutton',...
    ...
    'FontUnit','Pixel','Fontsize',14,...
    'Units','Pixels',...
    'Position',[mainPanelWidth-70 mainPanelHeight-155 60 35],...
...
uicontrol('Tag','data_panel_button_explanation',...
    ...
    'FontAngle','oblique',...
    'Position',[75 mainPanelHeight-150 mainPanelWidth-150 20],...
...
uicontrol('Tag','data_panel_showonlyactive_checkbox',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[10 mainPanelHeight-295 100 25],...
...
pp1_p3 = uipanel('Tag','results_panel_displaytype_panel',...
    'Parent',pp1,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[10 mainPanelHeight-360 panel_size 50],...
    'Title','Display type'...
    );
...
pp1_p4 = uipanel('Tag','data_panel_dimensions_panel',...
    'Parent',pp1,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[10 mainPanelHeight-540 panel_size 170],...
    'Title','Dimensions'...
    );
...
pp2_p1 = uipanel('Tag','data_panel_master_panel',...
    'Parent',pp2,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
...
pp2_p2 = uipanel('Tag','results_panel_label_panel',...
    'Parent',pp2,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
...
uicontrol('Tag','results_panel_accumulate_pushbutton',...
    'Style','pushbutton',...
    'Parent',pp2,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[mainPanelWidth-110 mainPanelHeight-195 100 45],...
    'String','Accumulate',...
    'TooltipString','Remove currently highlighted spectrum from list of accumulated spectra',...
    'Enable','on',...
...
pp2_p3 = uipanel('Tag','results_panel_dimensions_panel',...
    'Parent',pp2,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
...
uicontrol('Tag','results_panel_dimensions_y_text',...f
    'Style','text',...
    'Parent',pp2_p3,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
...
pp2_p4 = uipanel('Tag','results_panel_report_panel',...
    'Parent',pp2,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[10 mainPanelHeight-425 panel_size 55],...
    'Title','Report'...
    );
...
uicontrol('Tag','results_panel_report_save_pushbutton',...
    ...
    'pos',[((panel_size-20)/3*2)+10 10 (panel_size-20)/3 25],...
    'Enable','on',...
    'Callback',{@report_save_pushbutton_Callback}...
    );

pp2_p5 = uipanel('Tag','results_panel_position_panel',...
    'Parent',pp2,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
...
% elements for pp3
pp3_p1 = uipanel('Tag','accumulation_panel',...
    'parent',pp3,...
...
pp3_p2 = uipanel('Tag','weighting_panel',...
    'parent',pp3,...
    'Title','Weighting',...
    'FontUnit','Pixel','Fontsize',12,...
    'BackgroundColor',defaultBackground,...
...
pp3_p4 = uipanel('Tag','interpolation_panel',...
    'parent',pp3,...
