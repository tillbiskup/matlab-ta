...
function updateAxes()
    try
        ...
        % THIS FIRST PART JUST DEALS WITH THE ACCUMULATED DATA.
        %
        % For the non-accumulated data display see below (else branch)
        if isfield(ad.acc,'data') && ~isempty(ad.acc.data)
                    ...
                    switch ad.control.axis.MFEdisplay
                        case 'MFon'
                            imagesc(...
                                x,...
                                y,...
                                ad.acc.data.dataMFon...
                                );
                        case 'DeltaMF'
                            imagesc(...
                                x,...
                                y,...
                                ad.acc.data.dataMFon-ad.acc.data.data...
                                );
                        case 'sum(MFoff,MFon)'
                            imagesc(...
                                x,...
                                y,...
                                (ad.acc.data.dataMFon+ad.acc.data.data)./2 ...
                                );
                        otherwise
                            imagesc(...
                                x,...
                    ...
                    switch ad.control.axis.MFEdisplay
                        case 'MFon'
                            plot(...
                                x,...
                                yMF,...
                                'Color',ad.acc.data.display.MFon.line.color,...
                                'LineStyle',ad.acc.data.display.MFon.line.style,...
                                'Marker',ad.acc.data.display.MFon.line.marker.type,...
                                'LineWidth',ad.acc.data.display.MFon.line.width...
                                );
                            % Set limits of axis
                            set(gca,...
                                'XLim',[min(x) max(x)],...
                                'YLim',[min(min(yMF))*1.025 ...
                                max(max(yMF))*1.025]...
                                );
                        case 'DeltaMF'
                            plot(...
                                x,...
                                yMF-y,...
                                'Color',ad.acc.data.display.DeltaMF.line.color,...
                                'LineStyle',ad.acc.data.display.DeltaMF.line.style,...
                                'Marker',ad.acc.data.display.DeltaMF.line.marker.type,...
                                'LineWidth',ad.acc.data.display.DeltaMF.line.width...
                                );
                            % Set limits of axis
                            set(gca,...
                                'XLim',[min(x) max(x)],...
                                'YLim',[min(min(yMF-y))*1.025 ...
                                max(max(yMF-y))*1.025]...
                                );
                        case 'sum(MFoff,MFon)'
                            plot(...
                            ...
                            set(gca,...
                                'XLim',[min(x) max(x)],...
                                'YLim',[min(min((yMF+y)./2))*1.025 ...
                                max(max((yMF+y)./2))*1.025]...
                                );
                        otherwise
                            plot(...
                                x,...
                ...
                case '1D along y'
                    ...
                    switch ad.control.axis.MFEdisplay
                        ...
                        case 'sum(MFoff,MFon)'
                            ...
                            set(gca,...
                                'XLim',[min(y) max(y)],...
                                'YLim',[min(min((xMF+x)./2))*1.025 ...
                                max(max((xMF+x)./2))*1.025]...
                                );
                        otherwise
                            plot(...
                                y,...
            ...
            switch ad.control.axis.displayType
                    ...
                    switch ad.control.axis.MFEdisplay
                        case 'MFon'
                            imagesc(...
                                x,...
                                y,...
                                ad.data{active}.dataMFon...
                                );
                        case 'DeltaMF'
                            imagesc(...
                                x,...
                                y,...
                                ad.data{active}.dataMFon-ad.data{active}.data...
                                );
                        case 'sum(MFoff,MFon)'
                            imagesc(...
                                x,...
                                y,...
                                (ad.data{active}.dataMFon+ad.data{active}.data)./2 ...
                                );
                        otherwise
                            imagesc(...
                                x,...
                ...
                case '1D along x'
                    ...
                    if ad.control.axis.onlyActive
                        ...
                        % Set limits of axis - here: be lazy, just set XLim
                        set(gca,...
                            'XLim',[min(x) max(x)] ...
                            );
                    end
