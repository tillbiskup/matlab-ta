...
pp1_p3 = uipanel('Tag','data_panel_dimensions_panel',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[10 mainPanelHeight-450 panel_size 170],...
...
uicontrol('Tag','data_panel_mfedisplaytype_popupmenu',...
    'Style','popupmenu',...
    'Parent',pp1_p4,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
...
pp2_p2 = uipanel('Tag','settings_panel_methods_panel',...
    'parent',pp2,...
    'Title','Methods',...
    'FontUnit','Pixel','Fontsize',12,...
    'BackgroundColor',defaultBackground,...
    ...
    try
        ...
        switch action
            ...
            case 'next'
                ...
                set(gh.data_panel_accumulated_listbox,'Value',selected);
                updateSpectra();
                updateDimensionPanel('Datasets');
            case 'prev'
                if isempty(ad.control.spectra.accumulated)
...
function updateSpectra()
    try
        ...
        if length(acc)>0
            ...
            set(gh.accumulate_panel_master_popupmenu,'String',masterDatasetString);
            set(gh.accumulate_panel_master_popupmenu,...
                'Value',find(acc==ad.control.spectra.active));
            set(gh.accumulate_panel_master_popupmenu,'Enable','on');
            ...
            set(gh.accumulate_panel_master_popupmenu,'String','none');
            set(gh.accumulate_panel_master_popupmenu,'Value',1);
            set(gh.accumulate_panel_master_popupmenu,'Enable','off');
        end
        if length(nacc)>0
...
function setAccParameters()
    try
        ...
        ad.acc.master = ad.control.spectra.accumulated(...
            get(gh.accumulate_panel_master_popupmenu,'Value'));
