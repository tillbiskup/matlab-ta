...
singleton = findobj('Tag','TAgui_AVGwindow');
if (singleton)
    figure(singleton);
...
%  Construct the components
hMainFigure = figure('Tag','TAgui_AVGwindow',...
    'Visible','off',...
    ...
    try
        ...
        switch action
            ...
            case 'linemarker'
                ...
                switch MFEline
                    case 'MFoff'
                        ad.avg.MFoff.line.marker = value;
                    case 'MFon'
                        ad.avg.MFon.line.marker = value;
                    case 'DeltaMF'
                        ad.avg.DeltaMF.line.marker = value;
                    otherwise
                        disp(['TAgui : guiMFEPanel() : '...
                            'popupmenu_Callback(): Unknown MFElineType '...
                            '"' MFEline '"']);
        ...
        switch MFEline
            case 'MFoff'
                ...
                set(gh.avg_panel_linemarker_popupmenu,'Value',...
                    find(strcmpi(...
                    lineMarker{strcmpi(ad.avg.MFoff.line.marker,...
            ...
            case 'MFon'
                ...
                set(gh.avg_panel_linemarker_popupmenu,'Value',...
                    ...
                    strcmpi(ad.avg.MFon.line.marker,...
                    lineMarker(:,2)),1},lineMarkerValues)));
            case 'DeltaMF'
                % Set colour sample
                set(gh.avg_panel_coloursample_text,'BackgroundColor',...
                ...
                set(gh.avg_panel_linemarker_popupmenu,'Value',...
                    find(strcmpi(lineMarker{...
                    strcmpi(ad.avg.DeltaMF.line.marker,...
                    lineMarker(:,2)),1},lineMarkerValues)));
            case 'smoothing'
                % Set colour sample
                set(gh.avg_panel_coloursample_text,'BackgroundColor',...
                ...
                set(gh.avg_panel_linemarker_popupmenu,'Value',...
                    find(strcmpi(lineMarker{...
                    strcmpi(ad.avg.smoothing.line.marker,...
                    lineMarker(:,2)),1},lineMarkerValues)));
            otherwise
    ...
    try
        ...
        switch ad.control.axis.displayType
            ...
            case '1D along x'
                ...
                hold on;
                if ad.avg.display.original || ~ad.data{active}.avg.delta
                    switch ad.control.axis.MFEdisplay
                        case 'MFoff'
                            plot(...
                                xvalues,...
                ...
                if ad.data{active}.avg.delta && strcmpi(ad.avg.dimension,'y')
                    ...
                    ymean = mean(data(ad.data{active}.avg.start:...
                        ad.data{active}.avg.stop,:),1);
                    ystd = std(data(ad.data{active}.avg.start:...
                        ad.data{active}.avg.stop,:),0,1);
                    if isfield(ad.data{active},'dataMFon')
                        yMF = mean(dataMFon(ad.data{active}.avg.start:...
                            ad.data{active}.avg.stop,:),1);
                        yMFstd = std(dataMFon(ad.data{active}.avg.start:...
                            ad.data{active}.avg.stop,:),0,1);
                        yDeltaMF = mean(...
                            (dataMFon(ad.data{active}.avg.start:...
                            ad.data{active}.avg.stop,:)-...
                            data(ad.data{active}.avg.start:...
                            ad.data{active}.avg.stop,:)),1);
                        yDeltaMFstd = std(...
                            (dataMFon(ad.data{active}.avg.start:...
                            ad.data{active}.avg.stop,:)-...
                        ...
                        ySumMF = mean(...
                            ...
                            ad.data{active}.avg.stop,:)+...
                            data(ad.data{active}.avg.start:...
                            ad.data{active}.avg.stop,:))./2,1);
                        ySumMFstd = std(...
                            (dataMFon(ad.data{active}.avg.start:...
                            ad.data{active}.avg.stop,:)+...
                            data(ad.data{active}.avg.start:...
                            ad.data{active}.avg.stop,:))./2,0,1);
                    else
                        yMF = yvalues;
                        yMFstd = ystd;
                    ...
                    switch ad.control.axis.MFEdisplay
                        case 'MFoff'
                            plot(gh.axis,...
                                ...
                                'Marker',ad.avg.MFoff.line.marker,...
                        ...
                        case 'MFoff+MFon'
                            ...
                            plot(gh.axis,...
                                ...
                                'Marker',ad.avg.MFon.line.marker,...
                        ...
                        case 'MFoff+MFon+DeltaMF'
                            ...
                            plot(gh.axis,...
                                ...
                                'Marker',ad.avg.DeltaMF.line.marker,...
            ...
            case '1D along y'
                ...
                if ad.data{active}.avg.delta && strcmpi(ad.avg.dimension,'x')
                    % Plot average spectrum
                    xmean = mean(data(:,ad.data{active}.avg.start:...
                        ad.data{active}.avg.stop),2);
                    xstd = std(data(:,ad.data{active}.avg.start:...
                        ad.data{active}.avg.stop),0,2);
                    if isfield(ad.data{active},'dataMFon')
                        xMF = mean(dataMFon(:,ad.data{active}.avg.start:...
                            ad.data{active}.avg.stop),2);
                        xMFstd = std(dataMFon(:,ad.data{active}.avg.start:...
                            ad.data{active}.avg.stop),0,2);
                        xDeltaMF = mean(...
                            (dataMFon(:,ad.data{active}.avg.start:...
                            ad.data{active}.avg.stop)-...
                        ...
                        xSumMF = mean(...
                            ...
                            ad.data{active}.avg.stop)+...
                            data(:,ad.data{active}.avg.start:...
                            ad.data{active}.avg.stop))./2,2);
                        xSumMFstd = std(...
                            (dataMFon(:,ad.data{active}.avg.start:...
                            ad.data{active}.avg.stop)+...
                            data(:,ad.data{active}.avg.start:...
                            ad.data{active}.avg.stop))./2,0,2);
                    else
                        xMF = xvalues;
                        xMFstd = xstd;
