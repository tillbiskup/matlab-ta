...
pp1_p22 = uipanel('Tag','displaytype_panel',...
    'Parent',pp1,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
...
TAmsg('MFE GUI window opened','info');
    ...
    try
        ...
        switch lower(action)
            ...
            case 'linemarker'
                ...
                switch MFEline
                    case 'MFoff'
                        ad.mfe.MFoff.line.marker.type = value;
                    case 'MFon'
                        ad.mfe.MFon.line.marker.type = value;
                    case 'DeltaMF'
                        ad.mfe.DeltaMF.line.marker.type = value;
                    case 'smoothing'
                        ad.mfe.smoothing.line.marker.type = value;
                    otherwise
                        disp(['TAgui : guiMFEPanel() : '...
                            'popupmenu_Callback(): Unknown MFElineType '...
                            '"' MFEline '"']);
    ...
    try
        ...
        switch action
            ...
            case 'SettingsDefault'
                ...
                return;
            case 'Close'
                TAmsg('MFE GUI window closed.','info');
        ...
        switch MFEline
            case 'MFoff'
                ...
                set(gh.mfe_panel_linemarker_popupmenu,'Value',...
                    find(strcmpi(...
                    lineMarker{strcmpi(ad.mfe.MFoff.line.marker.type,...
            ...
            case 'MFon'
                ...
                set(gh.mfe_panel_linemarker_popupmenu,'Value',...
                    ...
                    strcmpi(ad.mfe.MFon.line.marker.type,...
                    lineMarker(:,2)),1},lineMarkerValues)));
            case 'DeltaMF'
                % Set colour sample
                set(gh.mfe_panel_coloursample_text,'BackgroundColor',...
                ...
                set(gh.mfe_panel_linemarker_popupmenu,'Value',...
                    find(strcmpi(lineMarker{...
                    strcmpi(ad.mfe.DeltaMF.line.marker.type,...
                    lineMarker(:,2)),1},lineMarkerValues)));
            case 'smoothing'
                % Set colour sample
                set(gh.mfe_panel_coloursample_text,'BackgroundColor',...
                ...
                set(gh.mfe_panel_linemarker_popupmenu,'Value',...
                    find(strcmpi(lineMarker{...
                    strcmpi(ad.mfe.smoothing.line.marker.type,...
                    lineMarker(:,2)),1},lineMarkerValues)));
            otherwise
        ...
        switch ad.control.axis.displayType
                ...
                switch ad.control.axis.MFEdisplay
                    case 'MFoff'
                        plot(...
                            ...
                            'Marker',ad.mfe.MFoff.line.marker.type,...
                    ...
                    case 'MFoff+MFon'
                        ...
                        plot(...
                            ...
                            'Marker',ad.mfe.MFon.line.marker.type,...
                    ...
                    case 'MFoff+MFon+DeltaMF'
                        ...
                        plot(...
                            ...
                            'Marker',ad.mfe.DeltaMF.line.marker.type,...
                        ...
                        if ad.mfe.display.smoothing && ...
                            ...
                            plot(...
                                ...
                                'Marker',ad.mfe.smoothing.line.marker.type,...
            ...
            case '1D along y'
                ...
                if isscalar(yvalues)
                    ...
                    ad.mfe.MFoff.line.marker.type = 'o';
                    ad.mfe.MFon.line.marker.type = 'o';
                    ad.mfe.DeltaMF.line.marker.type = 'o';
                else
