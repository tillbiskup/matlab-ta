...
uicontrol('Tag','mfe_display_smoothing_checkbox',...
    ...
    'BackgroundColor',defaultBackground,...
    'Enable','on',...
    'TooltipString','Check to display display mean MFE value as area in main display',...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
...
uicontrol('Tag','mfe_display_mfemean_checkbox',...
    ...
    'BackgroundColor',defaultBackground,...
    'Enable','on',...
    'TooltipString','Check to display mean MFE value as horizontal line in main display',...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[20 10 100 25],...
    'String','mean',...
