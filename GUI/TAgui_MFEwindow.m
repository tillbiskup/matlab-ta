function varargout = TAgui_MFEwindow(varargin)
% TAGUI_MFEWINDOW Provide user with all necessary controls to perform
...
tb2 = uicontrol('Tag','mfe_togglebutton',...
    'Style','Toggle',...
	'Parent', hButtonGroup, ...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'String','MFE',...
    'TooltipString','MFE calculation',...
...
tb3 = uicontrol('Tag','settings_togglebutton',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'String','Settings',...
    'TooltipString','Control settings of the MFE GUI',...
...
pp1_p2 = uipanel('Tag','displaytype_panel',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[10 mainPanelHeight-175 mainPanelWidth-20 50],...
    'Title','Display type'...
    );
...
pp1_p3 = uipanel('Tag','mfe_displaytype_panel',...
    'Parent',pp1,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[10 mainPanelHeight-230 mainPanelWidth-20 50],...
...
pp1_p4 = uipanel('Tag','sliderposition_panel',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[10 mainPanelHeight-375 mainPanelWidth-20 140],...
...
pp1_p5 = uipanel('Tag','measure_panel',...
    'Parent',pp1,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[10 mainPanelHeight-520 mainPanelWidth-20 140],...
    'Title','Measure'...
    );
...
pp2_p1 = uipanel('Tag','averagearea_panel',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[10 mainPanelHeight-190 mainPanelWidth-20 170],...
    'Title','Average area'...
    );
...
pp2_p2 = uipanel('Tag','mfe_displayoptions_panel',...
    'Parent',pp2,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[10 mainPanelHeight-290 mainPanelWidth-20 90],...
    'Title','MFE display options'...
    );
uicontrol('Tag','mfe_display_avgarea_checkbox',...
    'Style','checkbox',...
    'Parent',pp2_p2,...
    'BackgroundColor',defaultBackground,...
    'Enable','on',...
    'TooltipString','Check to display AVG area in main display',...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[20 40 100 25],...
    'String','AVG area',...
    'Value',0,...
...
uicontrol('Tag','mfe_display_smoothing_checkbox',...
    ...
    'Check to display display smoothed trace', 'of the DeltaMF trace'),...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
...
uicontrol('Tag','mfe_display_mfemean_checkbox',...
    ...
    'String','Mean',...
    'Value',0,...
    'Callback',{@checkbox_Callback,'mean'}...
    );
uicontrol('Tag','mfe_display_mfestdev_checkbox',...
    ...
    'Enable','on',...
    'TooltipString',sprintf('%s\n%s',...
    'Check to display display std deviation as error bars',...
    'in "1D along y" display mode in main display'),...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
...
uicontrol('Tag','mfe_pushbutton',...
    ...
    'pos',[10+(mainPanelWidth-20)/2 mainPanelHeight-345 (mainPanelWidth-20)/2 40],...
    'Enable','on',...
    'Callback',{@pushbutton_Callback,'MFE'}...
    );

pp2_p3 = uipanel('Tag','mfereport_panel',...
    'Parent',pp2,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[10 mainPanelHeight-530 mainPanelWidth-20 175],...
    'Title','MFE report'...
    );
uicontrol('Tag','mfereport_edit',...
    'Style','edit',...
    'Parent',pp2_p3,...
    ...
    'Units','Pixels',...
    'Position',[10 40 mainPanelWidth-40 115],...
    'Min',0,'Max',2,...
    'String','Nothing to report yet'...
    );
uicontrol('Tag','mfereport_save_pushbutton',...
    'Style','pushbutton',...
    'Parent',pp2_p3,...
    'BackgroundColor',defaultBackground,...
    'Enable','on',...
    ...
    'Position',[60+(mainPanelWidth-90)/2 10 (mainPanelWidth-90)/2 25],...
    'String','Save',...
    'TooltipString','Save MFE report to a text file',...
...
pp3_p3 = uipanel('Tag','mfe_panel_line_panel',...
    'Parent',pp3,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
...
uicontrol('Tag','mfe_panel_line_popupmenu',...
    ...
    'String','MFoff|MFon|DeltaMF|smoothing',...
...
pp3_p4 = uipanel('Tag','processing_panel_average_panel',...
    'Parent',pp3,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[10 mainPanelHeight-495 mainPanelWidth-20 110],...
...
uicontrol('Tag','processing_panel_average_type_popupmenu',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[55 65 mainPanelWidth-80 20],...
    'String','boxcar',...
...
uicontrol('Tag','processing_panel_average_x_points_edit',...
    ...
    'Position',[60 10 (mainPanelWidth-90)/2 25],...
    'String','1',...
    'Callback',{@edit_Callback,'smoothxindex'}...
    );
uicontrol('Tag','processing_panel_average_x_unit_edit',...
    ...
    'Position',[60+(mainPanelWidth-90)/2 10 (mainPanelWidth-90)/2 25],...
    'String','0',...
    'Callback',{@edit_Callback,'smoothxunit'}...
    );
...
uicontrol('Tag','settings_save_pushbutton',...
    ...
    'pos',[10 10 (mainPanelWidth-20)/2 35],...
    'Enable','off',...
...
uicontrol('Tag','settings_default_pushbutton',...
    ...
    'pos',[10+(mainPanelWidth-20)/2 10 (mainPanelWidth-20)/2 35],...
    'Enable','on',...
...
uicontrol('Tag','help_pushbutton',...
    ...
    'FontWeight','bold',...
    'String','?',...
    'TooltipString','Display help for how to operate the MFE GUI',...
    'pos',[panel_size*2+5 190 25 25],...
    'Enable','on',...
    'Callback',@TAgui_MFE_helpwindow...
    );
...
function checkbox_Callback(source,~,action)
    try
        ...
        switch action
            ...
            case 'mean'
                ad.mfe.display.mean = get(source,'Value');
            case 'stdev'
                ad.mfe.display.stdev = get(source,'Value');
            otherwise
...
function edit_Callback(source,~,field)
    try
        ...
        switch field
            case 'smoothxindex'
                [~,x] = size(ad.data{active}.data);
                % Fix values: only integers >= 1
                if (str2double(value) < 1) || ...
                        isnan(str2double(value))
                    set(source,'String','1');
                elseif (str2double(value) > x)
                    set(source,'String',num2str(x));
                else
                    set(source,'String',num2str(round(str2double(value))));
                end
                ad.mfe.smoothing.value = str2num(get(source,'String'));
                setappdata(mainWindow,'mfe',ad.mfe);
                updateSettingsPanel();
                updateAxes();
            case 'smoothxunit'
                ...
                if (isfield(ad.data{active},'axes') ...
                        && isfield(ad.data{active}.axes,'x') ...
                        && isfield(ad.data{active}.axes.x,'values') ...
                        && ~isempty(ad.data{active}.axes.x.values))
                    x = ad.data{active}.axes.x.values;
                end
                ...
                if (str2double(value) < atomic) || ...
                        isnan(str2double(value))
                    set(source,'String',num2str(atomic));
                elseif (str2double(value) > (atomic*length(x)))
                    set(source,'String',num2str(atomic*length(x)));
                else
                    set(source,...
                        'String',...
                        num2str(round(str2double(value)/atomic)*atomic)...
                        );
                end
    ...
    try
        ...
        switch lower(action)
            ...
            case 'linewidth'
                ...
                switch MFEline
                    case 'MFoff'
                        ad.mfe.MFoff.line.width = value;
                    case 'MFon'
                        ad.mfe.MFon.line.width = value;
                    case 'DeltaMF'
                        ad.mfe.DeltaMF.line.width = value;
                    case 'smoothing'
                        ad.mfe.smoothing.line.width = value;
                    otherwise
            ...
            case 'linestyle'
                ...
                switch MFEline
                    case 'MFoff'
                        ad.mfe.MFoff.line.style = value;
                    case 'MFon'
                        ad.mfe.MFon.line.style = value;
                    case 'DeltaMF'
                        ad.mfe.DeltaMF.line.style = value;
                    case 'smoothing'
                        ad.mfe.smoothing.line.style = value;
                    otherwise
                        disp(['TAgui : guiMFEPanel() : '...
                            'popupmenu_Callback(): Unknown MFElineType '...
                            '"' MFEline '"']);
            ...
            case 'linemarker'
                ...
                switch MFEline
                    case 'MFoff'
                        ad.mfe.MFoff.line.marker = value;
                    case 'MFon'
                        ad.mfe.MFon.line.marker = value;
                    case 'DeltaMF'
                        ad.mfe.DeltaMF.line.marker = value;
                    case 'smoothing'
                        ad.mfe.smoothing.line.marker = value;
                    otherwise
                        disp(['TAgui : guiMFEPanel() : '...
                            'popupmenu_Callback(): Unknown MFElineType '...
                            '"' MFEline '"']);
    ...
    try
        ...
        switch action
            ...
            case 'MFE'
                ...
                return;
            case 'reportSave'
                if ~active || ~ad.data{active}.mfe.delta
                    return;
                end
                mfe = TAMFE(ad.data{active},ad.data{active}.mfe);
                set(gh.mfereport_edit,'String',mfe.report);
                updateMFEPanel();
                updateAxes();
                [fpath,fname,~] = fileparts(ad.data{active}.file.name);
                reportSaveFile = sprintf('%s-MFEreport.txt',...
                    fullfile(fpath,fname));
                [fname,fpath] = uiputfile('*.txt',...
                    'Select file to save MFE report to',reportSaveFile);
                if ~isempty(fname)
                    status = textFileWrite(...
                        fullfile(fpath,fname),mfe.report);
                    if ~isempty(status)
                        add2status(status);
                    end
                end
            ...
            case 'lineColourPalette'
                ...
                switch MFEline
                    case 'MFoff'
                        ad.mfe.MFoff.line.color = uisetcolor(...
                            ad.mfe.MFoff.line.color,...
                            'Set MFoff line colour');
                    case 'MFon'
                        ad.mfe.MFon.line.color = ...
                            uisetcolor(...
                            ad.mfe.MFon.line.color,...
                            'Set MFon line colour');
                    case 'DeltaMF'
                        ad.mfe.DeltaMF.line.color = ...
                            uisetcolor(...
                            ad.mfe.DeltaMF.line.color,...
            ...
            case 'Close'
                ...
                % Look for MFE GUI Help window and if its there, close as
                % well
                hHelpWindow = findobj('Tag','TAgui_MFE_helpwindow');
...
function updateSettingsPanel(varargin)
    try
        ...
        if nargin && strcmpi('defaults',varargin{1})
            ...
            ad.control.axis.grid.zero = ad.configuration.axis.grid.zero;
            % Reset MFE settings
            ad.mfe.MFoff = ad.configuration.mfe.MFoff;
            ad.mfe.MFon = ad.configuration.mfe.MFon;
            ad.mfe.DeltaMF = ad.configuration.mfe.DeltaMF;
            ad.mfe.area = ad.configuration.mfe.area;            
            setappdata(mainWindow,'mfe',ad.mfe);
            setappdata(mainWindow,'control',ad.control);
        end
        ...
        lineStyleValues = ...
            cellstr(get(gh.mfe_panel_linestyle_popupmenu,'String'));
        
        % Get values of line marker popupmenu
        lineMarkerValues = ...
            cellstr(get(gh.mfe_panel_linemarker_popupmenu,'String'));

        switch MFEline
            case 'MFoff'
                % Set colour sample
                set(gh.mfe_panel_coloursample_text,'BackgroundColor',...
                    ad.mfe.MFoff.line.color);
                % Set line width
                set(gh.mfe_panel_linewidth_popupmenu,'Value',...
                    ad.mfe.MFoff.line.width);
                % Set line style
                set(gh.mfe_panel_linestyle_popupmenu,'Value',...
                    find(strcmpi(...
                    lineStyles{strcmpi(ad.mfe.MFoff.line.style,...
                    lineStyles(:,2)),1},lineStyleValues)));
                % Set line marker
                set(gh.mfe_panel_linemarker_popupmenu,'Value',...
                    find(strcmpi(...
                    lineMarker{strcmpi(ad.mfe.MFoff.line.marker,...
            ...
            case 'MFon'
                ...
                % Set line width
                set(gh.mfe_panel_linewidth_popupmenu,'Value',...
                    ad.mfe.MFon.line.width);
                % Set line style
                set(gh.mfe_panel_linestyle_popupmenu,'Value',...
                    find(strcmpi(lineStyles{...
                    strcmpi(ad.mfe.MFon.line.style,...
                    lineStyles(:,2)),1},lineStyleValues)));
                % Set line marker
                set(gh.mfe_panel_linemarker_popupmenu,'Value',...
                    find(strcmpi(lineMarker{...
                    strcmpi(ad.mfe.MFon.line.marker,...
                    lineMarker(:,2)),1},lineMarkerValues)));
            case 'DeltaMF'
                % Set colour sample
                set(gh.mfe_panel_coloursample_text,'BackgroundColor',...
                ...
                % Set line width
                set(gh.mfe_panel_linewidth_popupmenu,'Value',...
                    ad.mfe.DeltaMF.line.width);
                % Set line style
                set(gh.mfe_panel_linestyle_popupmenu,'Value',...
                    find(strcmpi(lineStyles{strcmpi(...
                    ad.mfe.DeltaMF.line.style,...
                    lineStyles(:,2)),1},lineStyleValues)));
                % Set line marker
                set(gh.mfe_panel_linemarker_popupmenu,'Value',...
                    find(strcmpi(lineMarker{...
                    strcmpi(ad.mfe.DeltaMF.line.marker,...
                    lineMarker(:,2)),1},lineMarkerValues)));
            case 'smoothing'
                % Set colour sample
                set(gh.mfe_panel_coloursample_text,'BackgroundColor',...
                    ad.mfe.smoothing.line.color)
                % Set line width
                set(gh.mfe_panel_linewidth_popupmenu,'Value',...
                    ad.mfe.smoothing.line.width);
                % Set line style
                set(gh.mfe_panel_linestyle_popupmenu,'Value',...
                    find(strcmpi(lineStyles{strcmpi(...
                    ad.mfe.smoothing.line.style,...
                    lineStyles(:,2)),1},lineStyleValues)));
                % Set line marker
                set(gh.mfe_panel_linemarker_popupmenu,'Value',...
                    find(strcmpi(lineMarker{...
                    strcmpi(ad.mfe.smoothing.line.marker,...
                    lineMarker(:,2)),1},lineMarkerValues)));
            otherwise
                disp(['TAgui_MFEwindow : updateSettingsPanel() : ',...
                    'Unknown MFElineType "' MFEline '"']);
        end
        % Update average x points display
        set(gh.processing_panel_average_x_points_edit,...
            'String',...
        ...
        set(gh.processing_panel_average_x_unit_edit,...
            'String',...
            num2str((x(2)-x(1))*ad.mfe.smoothing.value)...
            );
        ...
        ad.mfe.smoothing.filterfun = sprintf('TAfilter_%s',filterType);
...
function update_position_display()
    try
        ...
        if (isfield(ad.data{ad.control.spectra.active},'axes') ...
                && isfield(ad.data{ad.control.spectra.active}.axes,'y') ...
                && isfield(ad.data{ad.control.spectra.active}.axes.y,'values') ...
                && ~isempty(ad.data{ad.control.spectra.active}.axes.y.values))
            y = ad.data{ad.control.spectra.active}.axes.y.values;
        end
        ...
        if (isfield(ad.data{ad.control.spectra.active},'axes') ...
                && isfield(ad.data{ad.control.spectra.active}.axes,'x') ...
                && isfield(ad.data{ad.control.spectra.active}.axes.x,'values') ...
                && ~isempty(ad.data{ad.control.spectra.active}.axes.x.values))
            x = ad.data{ad.control.spectra.active}.axes.x.values;
        end
    ...
    try
        ...
        switch ad.control.axis.displayType
            ...
            case '1D along x'
                ...
                switch ad.control.axis.MFEdisplay
                    case 'MFoff'
                        plot(...
                            xvalues,...
                            yvalues,...
                            'Color',ad.mfe.MFoff.line.color,...
                            'LineStyle',ad.mfe.MFoff.line.style,...
                            'Marker',ad.mfe.MFoff.line.marker,...
                            'LineWidth',ad.mfe.MFoff.line.width...
                            );
                    case 'MFoff+MFon'
                        plot(...
                            xvalues,...
                        ...
                        plot(...
                            xvalues,...
                            yMF,...
                            'Color',ad.mfe.MFon.line.color,...
                            'LineStyle',ad.mfe.MFon.line.style,...
                            'Marker',ad.mfe.MFon.line.marker,...
                            'LineWidth',ad.mfe.MFon.line.width...
                            );
                    case 'MFoff+MFon+DeltaMF'
                        ...
                        plot(...
                            xvalues,...
                            yMF-yvalues,...
                            'Color',ad.mfe.DeltaMF.line.color,...
                            'LineStyle',ad.mfe.DeltaMF.line.style,...
                            'Marker',ad.mfe.DeltaMF.line.marker,...
                            'LineWidth',ad.mfe.DeltaMF.line.width...
                            );
                        if ad.mfe.display.smoothing && ...
                                ad.mfe.smoothing.value > 1
                            filterfun = str2func(ad.mfe.smoothing.filterfun);
                            plot(...
                                filterfun(xvalues,ad.mfe.smoothing.value),...
                                filterfun(yMF-yvalues,...
                                ad.mfe.smoothing.value),...
                                'Color',ad.mfe.smoothing.line.color,...
                                'LineStyle',ad.mfe.smoothing.line.style,...
                                'Marker',ad.mfe.smoothing.line.marker,...
                                'LineWidth',ad.mfe.smoothing.line.width...
                                );
                        end
                    case 'MFon'
                        plot(...
                ...
                if ad.data{active}.mfe.delta
                    xmean = mean(data(:,ad.data{active}.mfe.start:...
                        ad.data{active}.mfe.stop),2);
                    xstd = std(data(:,ad.data{active}.mfe.start:...
                        ad.data{active}.mfe.stop),0,2);
                    if isfield(ad.data{active},'dataMFon')
                        xMF = mean(dataMFon(:,ad.data{active}.mfe.start:...
                            ad.data{active}.mfe.stop),2);
                        xMFstd = std(dataMFon(:,ad.data{active}.mfe.start:...
                            ad.data{active}.mfe.stop),0,2);
                        xDeltaMF = mean(...
                            (dataMFon(:,ad.data{active}.mfe.start:...
                            ad.data{active}.mfe.stop)-...
                            data(:,ad.data{active}.mfe.start:...
                            ad.data{active}.mfe.stop)),2);
                        xDeltaMFstd = std(...
                            (dataMFon(:,ad.data{active}.mfe.start:...
                            ad.data{active}.mfe.stop)-...
                        ...
                        xSumMF = mean(...
                            ...
                            ad.data{active}.mfe.stop)+...
                            data(:,ad.data{active}.mfe.start:...
                            ad.data{active}.mfe.stop))./2,2);
                        xSumMFstd = std(...
                            (dataMFon(:,ad.data{active}.mfe.start:...
                            ad.data{active}.mfe.stop)+...
                            data(:,ad.data{active}.mfe.start:...
                            ad.data{active}.mfe.stop))./2,0,2);
                    else
                        xMF = xvalues;
                        xMFstd = xstd;
                        xDeltaMF = zeros(length(x),1);
                        xDeltaMFstd = zeros(length(x),1);
                        xSumMF = xvalues;
                        xSumMFstd = xstd;
                    end
                    XLim = get(gh.axis,'XLim');
                    if ad.mfe.display.mean
                        switch ad.control.axis.MFEdisplay
                            case 'MFoff'
                                plot(gh.axis,...
                                    XLim,...
                    ...
                    if ad.mfe.display.stdev
                        switch ad.control.axis.MFEdisplay
                            case 'MFoff'
                                plot(gh.axis,...
                                    XLim,...
                                    [xmean+xstd xmean+xstd],...
                                    XLim,...
                                    [xmean-xstd xmean-xstd],...
                                    'LineStyle',ad.mfe.MFoff.line.style,...
                                    'Color',ad.mfe.MFoff.line.color,...
                            ...
                            case 'MFoff+MFon+DeltaMF'
                                ...
                                plot(gh.axis,...
                                    XLim,...
                                    [xDeltaMF+xDeltaMFstd xDeltaMF+xDeltaMFstd],...
                                    XLim,...
                                    [xDeltaMF-xDeltaMFstd xDeltaMF-xDeltaMFstd],...
                                    'LineStyle',ad.mfe.DeltaMF.line.style,...
                                    'Color',ad.mfe.DeltaMF.line.color,...
                            ...
                            case 'sum(MFoff,MFon)'
                                plot(gh.axis,...
                                    XLim,...
                                    [xSumMF+xSumMFstd xSumMF+xSumMFstd],...
                                    XLim,...
                                    [xSumMF-xSumMFstd xSumMF-xSumMFstd],...
                                    'LineStyle',ad.mfe.MFoff.line.style,...
                                    'Color',ad.mfe.MFoff.line.color,...
            ...
            case '1D along y'
                ...
                if ad.data{active}.mfe.delta
                    set(gh.position_slider,'Enable','off');
                    xvalues = mean(data(:,ad.data{active}.mfe.start:...
                        ad.data{active}.mfe.stop),2);
                    xstd = std(data(:,ad.data{active}.mfe.start:...
                        ad.data{active}.mfe.stop),0,2);
                    if isfield(ad.data{active},'dataMFon')
                    ...
                    if isfield(ad.data{active},'dataMFon')
                        ...
                        xDeltaMF = xMF-xvalues;
                        xSumMF = (xMF+xvalues)./2;
                    else
                ...
                if isscalar(yvalues)
                    ...
                    ad.mfe.MFoff.line.marker = 'o';
                    ad.mfe.MFon.line.marker = 'o';
                    ad.mfe.DeltaMF.line.marker = 'o';
                else
                ...
                if ad.mfe.display.stdev && ad.data{active}.mfe.delta
                    switch ad.control.axis.MFEdisplay
                        case 'MFoff'
                            errorbar(gh.axis,...
                                yvalues,...
