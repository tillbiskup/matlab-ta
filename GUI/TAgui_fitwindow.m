    ...
    try
        ...
        switch action
            ...
            case 'linemarker'
                ...
                switch MFEline
                    case 'MFoff'
                        ad.fit.MFoff.line.marker.type = value;
                    case 'MFon'
                        ad.fit.MFon.line.marker.type = value;
                    case 'DeltaMF'
                        ad.fit.DeltaMF.line.marker.type = value;
                    case 'Residuals'
                        ad.fit.residuals.line.marker.type = value;
                    case 'Reference lines'
                        ad.fit.reference.line.marker.type = value;
                    otherwise
                        disp(['TAgui : guiMFEPanel() : '...
                            'popupmenu_Callback(): Unknown MFElineType '...
                            '"' MFEline '"']);
    ...
    try
        ...
        switch lower(action)
            ...
            case 'fit'
                ...
                [~,dfname,dfext] = fileparts(ad.data{active}.file.name);
                ad.fit.filename = [dfname dfext];
                setappdata(mainWindow,'fit',ad.fit);
                updateAxes();
                return;
            case 'showmaximum'
            ...
            case 'reportsave'
                ...
                if ~isfield(ad.fit,'filename')
                    fname = '';
                else
                    [~,fname,~] = fileparts(ad.fit.filename);
                end
                reportSaveFile = sprintf('%s-fitreport.txt',fname);
                ...
                return;
            case 'close'
                TAmsg('Fit GUI window closed.','info');
        ...
        switch MFEline
            case 'MFoff'
                ...
                set(gh.linesettings_linemarker_popupmenu,'Value',...
                    find(strcmpi(...
                    lineMarker{strcmpi(ad.fit.MFoff.line.marker.type,...
            ...
            case 'MFon'
                ...
                set(gh.linesettings_linemarker_popupmenu,'Value',...
                    find(strcmpi(...
                    lineMarker{strcmpi(ad.fit.MFon.line.marker.type,...
                    lineMarker(:,2)),1},lineMarkerValues)));
            case 'DeltaMF'
                % Set colour sample
                set(gh.linesettings_coloursample_text,'BackgroundColor',...
                ...
                set(gh.linesettings_linemarker_popupmenu,'Value',...
                    find(strcmpi(...
                    lineMarker{strcmpi(ad.fit.DeltaMF.line.marker.type,...
                    lineMarker(:,2)),1},lineMarkerValues)));
            case 'Residuals'
                % Set colour sample
                set(gh.linesettings_coloursample_text,'BackgroundColor',...
                ...
                set(gh.linesettings_linemarker_popupmenu,'Value',...
                    ...
                    strcmpi(ad.fit.residuals.line.marker.type,...
                    lineMarker(:,2)),1},lineMarkerValues)));
            case 'Reference lines'
                % Set colour sample
                set(gh.linesettings_coloursample_text,'BackgroundColor',...
                ...
                set(gh.linesettings_linemarker_popupmenu,'Value',...
                    find(strcmpi(lineMarker{...
                    strcmpi(ad.fit.reference.line.marker.type,...
                    lineMarker(:,2)),1},lineMarkerValues)));
            otherwise
            ...
            case '1D along x'
                ...
                if ~isempty(ad.fit.values) && strcmpi(ad.fit.dimension,'x')
                    plot(gh.axis,...
                        ...
                        'Marker',ad.fit.MFoff.line.marker.type,...
                ...
                if ~isempty(ad.fit.values) && ad.fit.display.residuals ...
                    ...
                    plot(gh.axis,...
                        ...
                        'Marker',ad.fit.residuals.line.marker.type,...
...
function [fit,fval,message] = doFit(data,fitFunType,ignorefirstn)
    function stop = outfun(x, optimValues, state) %#ok<INUSL,INUSD>
        stop = false;
