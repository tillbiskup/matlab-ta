...
p2p13 = uipanel('Tag','parameter_timeprofiles_panel',...
    'parent',p2pp3,...
    'Title','Time Profiles',...
    'FontUnit','Pixel','Fontsize',12,...
    'BackgroundColor',defaultBackground,...
    'Visible','on',...
    'Units','pixels',...
    'Position',[mainPanelWidth+10 subPanelHeight-430 mainPanelWidth 210]);
uicontrol('Tag','parameter_panel_tpprev_button',...
    'Style','pushbutton',...
    'Parent',p2p13,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'String','<html>&lt;</html>',...
    'TooltipString','Show info for previous time profile',...
    'Position',[10 160 45 25],...
    'Enable','on',...
    'Callback',{@pushbutton_Callback,'timeProfilesPrev'}...
    );
uicontrol('Tag','parameter_panel_tpnext_button',...
    'Style','pushbutton',...
    'Parent',p2p13,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'String','<html>&gt;</html>',...
    'TooltipString','Show info for next time profile',...
    'Position',[55 160 45 25],...
    'Enable','on',...
    'Callback',{@pushbutton_Callback,'timeProfilesNext'}...
    );
uicontrol('Tag','parameter_panel_tpnocurrent_edit',...
    'Style','edit',...
    'Parent',p2p13,...
    'BackgroundColor',editableBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[110 160 (mainPanelWidth-120)/3 25],...
    'String','0',...
    'Callback',{@parameter_edit_Callback,'timeProfilesCurrent'}...
    );
uicontrol('Tag','parameter_panel_tpno_text',...
    'Style','text',...
    'Parent',p2p13,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'HorizontalAlignment','center',...
    'Units','Pixels',...
    'Position',[110+(mainPanelWidth-120)/3 160 (mainPanelWidth-120)/3 20],...
    'String','of'...
    );
uicontrol('Tag','parameter_panel_tpnototal_edit',...
    'Style','edit',...
    'Parent',p2p13,...
    'BackgroundColor',noneditableBackground,...
    'FontUnit','Pixel','Fontsize',12,...
...
uicontrol('Tag','parameter_panel_tpfilename_text',...
    'Style','text',...
    'Parent',p2p13,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
...
uicontrol('Tag','parameter_panel_tpfilename_edit',...
    'Style','edit',...
    'Parent',p2p13,...
    'BackgroundColor',editableBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    ...
    'Position',[110 130 mainPanelWidth-120 25],...
    'String','N/A',...
    'Callback',{@parameter_edit_Callback,'tpfilename'}...
    );
uicontrol('Tag','parameter_panel_tpwavelength_text',...
    'Style','text',...
    'Parent',p2p13,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
...
uicontrol('Tag','parameter_panel_tpwavelength_edit',...
    'Style','edit',...
    'Parent',p2p13,...
    'BackgroundColor',editableBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    ...
    'Position',[110 100 (mainPanelWidth-120)/3*2 25],...
    'String','0',...
    'Callback',{@parameter_edit_Callback,'tpwavelength'}...
    );
uicontrol('Tag','parameter_panel_tpwavelengthunit_edit',...
    'Style','edit',...
    'Parent',p2p13,...
    'BackgroundColor',editableBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    ...
    'Position',[110+(mainPanelWidth-120)/3*2 100 (mainPanelWidth-120)/3 25],...
    'String','nm',...
    'Callback',{@parameter_edit_Callback,'tpwavelengthunit'}...
    );
uicontrol('Tag','parameter_panel_tpaverages_text',...
    'Style','text',...
    'Parent',p2p13,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
...
uicontrol('Tag','parameter_panel_tpaverages_edit',...
    'Style','edit',...
    'Parent',p2p13,...
    'BackgroundColor',editableBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    ...
    'Position',[110 70 mainPanelWidth-120 25],...
    'String','0',...
    'Callback',{@parameter_edit_Callback,'tpaverages'}...
    );
uicontrol('Tag','parameter_panel_tpruns_text',...
    'Style','text',...
    'Parent',p2p13,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
...
uicontrol('Tag','parameter_panel_tpruns_edit',...
    'Style','edit',...
    'Parent',p2p13,...
    'BackgroundColor',editableBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    ...
    'Position',[110 40 mainPanelWidth-120 25],...
    'String','0',...
    'Callback',{@parameter_edit_Callback,'tpruns'}...
    );
uicontrol('Tag','parameter_panel_tpfilter_text',...
    'Style','text',...
    'Parent',p2p13,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
...
uicontrol('Tag','parameter_panel_tpfilter_edit',...
    'Style','edit',...
    'Parent',p2p13,...
    'BackgroundColor',editableBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    ...
    'Position',[110 10 mainPanelWidth-120 25],...
    'String','N/A',...
    'Callback',{@parameter_edit_Callback,'tpfilter'}...
    );
...
p3p5 = uipanel('Tag','history_panel_report_panel',...
    'parent',p3,...
    'Title','Report',...
    'FontUnit','Pixel','Fontsize',12,...
    'BackgroundColor',defaultBackground,...
...
if (mainGuiWindow)
    ...
    if (isfield(admain,'control') ~= 0)
        ...
        for m=1:length(ad.control.spectra.loaded)
            ...
            % Set timeProfile cell array to default value
            ad.control.spectra.timeProfile{m} = 0;
...
function parameter_edit_Callback(source,~,value)
    try
        ...
        % Handle timeProfiles if present
        matchingTimeProfiles = {...
            'tpfilename','filename','',''; ...
            'tpwavelength','wavelength.value','str2double',''; ...
            'tpwavelengthunit','wavelength.unit','',''; ...
            'tpaverages','averages','str2double',''; ...
            'tpruns','runs','str2double',''; ...
            'tpfilter','filter','',''; ...
            };
        ...
        elseif matchesTimeProfiles
            if length(ad.data{ad.control.spectra.active}.parameters.timeProfiles)<=1
                return
            end
            % Check whether there is some function to apply first
            if ~isempty(matching{index,3})
            ...
            switch lower(value)
                case 'timeprofilescurrent'
                    active = ad.control.spectra.active;
                    fieldValue = str2double(fieldValue);
                    if isnan(fieldValue) ...
                            || ~ad.control.spectra.timeProfile{active}
                        % Update parameter panel
                        updateParameterPanel();
                        return;
                    end
                    if fieldValue > length(ad.data{active}.parameters.timeProfiles)
                        ad.control.spectra.timeProfile{active} = ...
                            length(ad.data{active}.parameters.timeProfiles);
                    elseif fieldValue < 1
                        ad.control.spectra.timeProfile{active} = 1;
                    else
                        ad.control.spectra.timeProfile{active} = fieldValue;
                    end
                otherwise
                    fprintf(...
                        ['TAgui_infowindow : parameter_edit_Callback : '...
                        'Unknown value "%s"\n'],value);
            end
        end
...
function pushbutton_Callback(~,~,action)
    try
        ...
        switch action
            case 'timeProfilesPrev'
                active = ad.control.spectra.active;
                if ~ad.control.spectra.timeProfile{active}
                    return;
                end
                if ad.control.spectra.timeProfile{active} == 1
                    ad.control.spectra.timeProfile{active} = ...
                        length(ad.data{active}.parameters.timeProfiles);
                else
                    ad.control.spectra.timeProfile{active} = ...
            ...
            case 'infofilereadapply'
                ...
                if isempty(warnings)
                    ...
                    % Workaround for unknown problem with structcopy
                    if isfield(parameters,'timeProfiles') ...
                            && length(parameters.timeProfiles)>1
                        ad.data{ad.control.spectra.active}.parameters.timeProfiles = ...
                            parameters.timeProfiles;
                    end
                    setappdata(mainWindow,'data',ad.data);
            ...
            otherwise
                fprintf(...
                    ['TAgui_infowindow : pushbutton_Callback : '...
                    'Unknown action "%s"\n'],action);
                return;
        end
    catch exception
...
function updateParameterPanel()
    try
        ...
        % Handle timeProfiles if present
        matchingTimeProfiles = {...
            'parameter_panel_tpfilename_edit','N/A','filename',''; ...
            'parameter_panel_tpwavelength_edit','0','wavelength.value',''; ...
            'parameter_panel_tpwavelengthunit_edit','nm','wavelength.unit',''; ...
            'parameter_panel_tpaverages_edit','0','averages',''; ...
            'parameter_panel_tpruns_edit','0','runs',''; ...
            'parameter_panel_tpfilter_edit','N/A','filter',''; ...
            };
        if isfield(ad.data{active}.parameters,'timeProfiles') ...
                && length(ad.data{active}.parameters.timeProfiles)>1
            set(gh.parameter_panel_tpnototal_edit,'String',...
                num2str(length(ad.data{active}.parameters.timeProfiles)));
        
            % Set selected timeProfile for currently active dataset
            if ~(ad.control.spectra.timeProfile{active})
                ad.control.spectra.timeProfile{active} = 1;
            end
            timeProfileId = ad.control.spectra.timeProfile{active};
            set(gh.parameter_panel_tpnocurrent_edit,'String',...
                num2str(timeProfileId));
            for k=1:size(matchingTimeProfiles,1)
                if ~isempty(matchingTimeProfiles{k,3}) && ~isempty(...
                        getCascadedField(...
                        ad.data{active}.parameters.timeProfiles(timeProfileId),...
                        matchingTimeProfiles{k,3}))
                    if ~isempty(matchingTimeProfiles{k,4})
                        value = getCascadedField(...
                            ad.data{active}.parameters.timeProfiles(timeProfileId),...
                            matchingTimeProfiles{k,3});
                        set(gh.(matchingTimeProfiles{k,1}),'String',...
                            num2str(value(matchingTimeProfiles{k,4})));
                    else
                        set(gh.(matchingTimeProfiles{k,1}),'String',...
                            getCascadedField(...
                            ad.data{active}.parameters.timeProfiles(timeProfileId),...
                    ...
                    set(gh.(matchingTimeProfiles{k,1}),...
                        'String',matchingTimeProfiles{k,2});
                end
            end
        else
            % Empty all strings
            set(gh.parameter_panel_tpnocurrent_edit,'String','0');
            set(gh.parameter_panel_tpnototal_edit,'String','0');
            for k=1:size(matchingTimeProfiles,1)
                set(gh.(matchingTimeProfiles{k,1}),...
                    'String',matchingTimeProfiles{k,2});
            end
        ...
        ad.data{active}.axes.x.values = ...
            -ad.data{active}.parameters.transient.length/...
        ...
        ad.data{active}.axes.x.unit = ...
            ad.data{active}.parameters.transient.unit;
