...
uicontrol('Tag','tools_panel_metafileread_apply_pushbutton',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'String','Show',...
    'TooltipString','Show metafile in display below',...
    'pos',[70 10 (mainPanelWidth-80)/2 30],...
    'Enable','on',...
    'Callback',{@pushbutton_Callback,'metafilereadshow'}...
    );
uicontrol('Tag','tools_panel_metafileread_load_pushbutton',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'String','Apply',...
    'TooltipString',sprintf('%s\n%s','Parse contents of loaded metafile',...
        ...
        switch action
            case 'metafilereadfilename'
                ...
                if ischar(infoFileName)
                    ...
                    set(gh.tools_panel_metafiledisplay_edit,...
                        'String',infoFileText);
                    set(gh.tools_panel_metafileread_format_edit,...
                        'String',infoFileName);
                end
            case 'metafilereadshow'
