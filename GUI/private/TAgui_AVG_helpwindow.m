...
singleton = findobj('Tag','TAgui_AVG_helpwindow');
if (singleton)
    figure(singleton);
    return;
end
...
%  Construct the components
hMainFigure = figure('Tag','TAgui_AVG_helpwindow',...
    'Visible','off',...
...
try
    ...
    helpTextFile = fullfile(TAinfo('dir'),'GUI','private','helptexts','AVG','intro.txt');
        ...
        switch helpText
            case 'Introduction'
                ...
                helpTextFile = fullfile(...
                    TAinfo('dir'),'GUI','private','helptexts','AVG','intro.txt');
                helpText = textFileRead(helpTextFile);
                set(textdisplay,'String',helpText);
            case 'Display'
                % Read text from file and display it
                helpTextFile = fullfile(...
                    TAinfo('dir'),'GUI','private','helptexts','AVG','display.txt');
                helpText = textFileRead(helpTextFile);
                set(textdisplay,'String',helpText);
            case 'Average'
                % Read text from file and display it
                helpTextFile = fullfile(...
                    TAinfo('dir'),'GUI','private','helptexts','AVG','average.txt');
                helpText = textFileRead(helpTextFile);
                set(textdisplay,'String',helpText);
            case 'Settings'
                % Read text from file and display it
                helpTextFile = fullfile(...
                    TAinfo('dir'),'GUI','private','helptexts','AVG','settings.txt');
                helpText = textFileRead(helpTextFile);
                set(textdisplay,'String',helpText);
            case 'Key bindings'
                % Read text from file and display it
                helpTextFile = fullfile(...
                    TAinfo('dir'),'GUI','private','helptexts','AVG','keybindings.txt');
                helpText = textFileRead(helpTextFile);
                set(textdisplay,'String',helpText);
            otherwise
