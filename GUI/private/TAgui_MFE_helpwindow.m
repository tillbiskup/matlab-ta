...
try
    ...
    helpTextFile = fullfile(TAinfo('dir'),...
        'GUI','private','helptexts','MFE','intro.html');
    ...
    try
        ...
        switch helpText
            ...
            case 'Display'
                % Read text from file and display it
                helpTextFile = fullfile(TAinfo('dir'),...
                    'GUI','private','helptexts','MFE','display.html');
                browser.setCurrentLocation(helpTextFile);
            case 'MFE'
                % Read text from file and display it
                helpTextFile = fullfile(TAinfo('dir'),...
                    'GUI','private','helptexts','MFE','mfe.html');
                browser.setCurrentLocation(helpTextFile);
            case 'Settings'
                % Read text from file and display it
                helpTextFile = fullfile(TAinfo('dir'),...
                    'GUI','private','helptexts','MFE','settings.html');
                browser.setCurrentLocation(helpTextFile);
            case 'Key bindings'
                % Read text from file and display it
                helpTextFile = fullfile(TAinfo('dir'),...
                    'GUI','private','helptexts','MFE','keybindings.html');
                browser.setCurrentLocation(helpTextFile);
            otherwise
