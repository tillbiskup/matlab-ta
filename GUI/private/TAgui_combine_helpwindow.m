...
try
    ...
    helpTextFile = fullfile(TAinfo('dir'),'GUI','private','helptexts','combine','intro.txt');
        ...
        switch helpText
            case 'Introduction'
                ...
                helpTextFile = fullfile(...
                    TAinfo('dir'),'GUI','private','helptexts','combine','intro.txt');
                helpText = textFileRead(helpTextFile);
                set(textdisplay,'String',helpText);
            case 'Key bindings'
                % Read text from file and display it
                helpTextFile = fullfile(...
                    TAinfo('dir'),'GUI','private','helptexts','combine','keybindings.txt');
                helpText = textFileRead(helpTextFile);
                set(textdisplay,'String',helpText);
            otherwise
