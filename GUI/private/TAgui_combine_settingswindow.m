...
pp2 = uipanel('Tag','settings_panel',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[guiSize(1)-mainPanelWidth-20 guiSize(2)-265 mainPanelWidth 180],...
    'Title','Settings',...
    'Visible','On'...
    );
...
% ------------------------------------------------------------------------
% UI controls for pp2
pp2_p1 = uipanel('Tag','settings_panel_smoothing_panel',...
    'Parent',pp2,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[10 10 mainPanelWidth-20 80],...
...
% ------------------------------------------------------------------------
% UI controls for pp3
pp3_p1 = uipanel('Tag','averagearea_panel',...
    'Parent',pp3,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
