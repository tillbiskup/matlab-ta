...
hGeneralButton = uicontrol('Tag','bg_general_pushbutton',...
    ...
    'String','General',...
    'TooltipString',...
    'General help topics for using the TA GUI',...
    'Position',[0 0 95 25],...
...
hPanelsButton = uicontrol('Tag','bg_panels_pushbutton',...
    ...
    'String','Panels',...
    'TooltipString',...
    'Specific help for the different panels of the TA GUI',...
    'Position',[95 0 95 25],...
    'HandleVisibility','off',...
    'Value',0 ...
    );
...
uicontrol('Tag','heading_text',...
    ...
    'FontWeight','bold',...
    'Units','Pixels',...
    'Position',[210 guiSize(2)-35 guiSize(1)-20 20],...
...
try
    ...
    TAmsg('TA GUI help window opened.','info');
