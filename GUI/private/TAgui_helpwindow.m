...
% TAGUI_HELPWINDOW Help window for the TA GUI.
%
...
hpm = uicontrol('Tag','helptopic_popupmenu',...
    ...
    'Key bindings|Disclaimer|Bug reports|Other resources|',...
    '--- Help for Panels ---|',...
    ...
    if get(get(mgh.mainButtonGroup,'SelectedObject'),'Tag')
        ...
        switch get(get(mgh.mainButtonGroup,'SelectedObject'),'Tag')
            ...
            otherwise
                ...
                TAmsg('TAgui_helpwindow(): Unknown panel','warning');
        end
    else
        helpText = 'Welcome';
    end
...
function helptext_selector(helpText)
    try
        switch helpText
            ...
            otherwise
                % That shall never happen
                TAmsg('TAgui_helpwindow(): Unknown helptext','warning');
