...
handle_p11 = uipanel('Tag','display_panel_dataexport_panel',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[0 handle_size(4)-430 handle_size(3)-20 220],...
...
uicontrol('Tag','display_panel_dataexport_description',...
    ...
    'HorizontalAlignment','Left',...
    'FontAngle','oblique',...
    'Position',[10 170 handle_size(3)-40 20],...
...
uicontrol('Tag','display_panel_dataexport_includeaxis_checkbox',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[10 110 handle_size(3)-20 20],...
...
uicontrol('Tag','display_panel_dataexport_line_popupmenu',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[handle_size(3)-190 50 160 20],...
