...
handle_p8 = uipanel('Tag','display_panel_line_panel',...
    'Parent',handle_pp3,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[0 handle_size(4)-415 handle_size(3)-20 185],...
    'Title','Line settings'...
    );
uicontrol('Tag','display_panel_highlight2_checkbox',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[80 140 handle_size(3)-105 20],...
    'String',' Highlight active',...
    'TooltipString','Toggle between highlighting currently active dataset',...
    'Value',1,...
    'Callback',{@highlight_checkbox_Callback}...
...
handle_p9 = uipanel('Tag','display_panel_avg_panel',...
    'Parent',handle_pp3,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[0 handle_size(4)-480 handle_size(3)-20 55],...
    'Title','AVG settings'...
    );
...
handle_p13 = uipanel('Tag','display_panel_threshold_panel',...
    'Parent',handle_pp6,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
...
uicontrol('Tag','display_panel_threshold_max_checkbox',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[55 15 handle_size(3)-120 20],...
    'String','',...
    'TooltipString',sprintf('%s\n%s',...
...
uicontrol('Tag','display_panel_threshold_max_edit',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[80 13 (handle_size(3)-90)/2 25],...
    'String','0',...
    ...
    try
        ...
        switch label
            case 'min'
                ...
                ad.data{ad.control.spectra.active}.display.threshold.min.enable = ...
                    value;
                ad.data{ad.control.spectra.active}.display.threshold.min.value = ...
                    str2double(get(gh.display_panel_threshold_min_edit,'String'));
            case 'max'
                if value
                ...
                ad.data{ad.control.spectra.active}.display.threshold.max.enable = ...
                    value;
                ad.data{ad.control.spectra.active}.display.threshold.max.value = ...
                    str2double(get(gh.display_panel_threshold_max_edit,'String'));
            otherwise
                % That shall never happen
...
function threshold_edit_Callback(source,~,label)
    try
        ...
        switch label
            case 'min'
                if isempty(value)
                    value = min(min(ad.data{ad.control.spectra.active}.data));
            ...
            case 'max'
                if isempty(value)
                    value = max(max(ad.data{ad.control.spectra.active}.data));
                elseif isnan(str2double(value))
                    value = 0;
                else
                    value = str2double(value);
