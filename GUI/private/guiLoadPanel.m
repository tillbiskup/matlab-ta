...
p2 = uipanel('Tag','load_panel_preprocessing_panel',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[10 handle_size(4)-240 handle_size(3)-20 90],...
...
p3 = uipanel('Tag','load_panel_axislabels_panel',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[10 handle_size(4)-300 handle_size(3)-20 50],...
    'Title','Axis labels'...
    );
...
uicontrol('Tag','load_panel_load_pushbutton',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[10 handle_size(4)-410 60 40],...
    'String','Load',...
...
uicontrol('Tag','load_panel_load_pushbutton_text',...
    ...
    'HorizontalAlignment','Left',...
    'FontAngle','oblique',...
    'Position',[80 handle_size(4)-405 handle_size(3)-90 30],...
