...
%     'String',{'Data processing functions, such as filters, compensations, ...'}...
%     );
...
uicontrol('Tag','processing_panel_page2_pushbutton',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'String','3',...
    'TooltipString','Page 3: Grid, legend, normalise, highlight current dataset',...
...
handle_p22 = uipanel('Tag','processing_panel_mfon2mfoff_panel',...
    'Parent',handle_pp2,...
    'BackgroundColor',defaultBackground,...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
...
uicontrol('Tag','processing_panel_corrections_pretrigger_pushbutton',...
    ...
    'FontUnit','Pixel','Fontsize',12,...
    'Units','Pixels',...
    'Position',[10 10 handle_size(3)-40 30],...
    'String','sum(MFoff,MFon) / 2',...
    'TooltipString','Add MFon data to MFoff data',...
    'Callback',{@pushbutton_Callback,'MFon2MFoff'}...
    );
