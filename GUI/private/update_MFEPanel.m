...
switch MFEline
    case 'MFoff'
        ...
        set(gh.mfe_panel_linemarker_popupmenu,'Value',...
            find(strcmpi(lineMarker{strcmpi(ad.data{active}.line.marker,...
    ...
    case 'MFon'
        ...
        set(gh.mfe_panel_linemarker_popupmenu,'Value',...
            ...
            strcmpi(ad.data{active}.display.MFon.line.marker,...
            lineMarker(:,2)),1},lineMarkerValues)));
    case 'DeltaMF'
        % Set colour sample
        set(gh.mfe_panel_coloursample_text,'BackgroundColor',...
        ...
        set(gh.mfe_panel_linemarker_popupmenu,'Value',...
            find(strcmpi(lineMarker{...
            strcmpi(ad.data{active}.display.DeltaMF.line.marker,...
            lineMarker(:,2)),1},lineMarkerValues)));
    otherwise
