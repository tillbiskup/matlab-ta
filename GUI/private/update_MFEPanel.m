...
if isempty(ad.control.axis.highlight.method)
    set(gh.mfe_panel_highlight_checkbox,'Value',0);
else
    set(gh.mfe_panel_highlight_checkbox,'Value',1);
end
...
lineStyleValues = cellstr(get(gh.mfe_panel_linestyle_popupmenu,'String'));

% Get values of line marker popupmenu
lineMarkerValues = cellstr(get(gh.mfe_panel_linemarker_popupmenu,'String'));
...
switch MFEline
    case 'MFoff'
        ...
        lineMarkerEdgeColorPopupmenuValues = ...
            cellstr(get(gh.mfe_panel_markeredgecolour_popupmenu,'String'));
        if ischar(lineMarkerEdgeColor) && length(lineMarkerEdgeColor)>1
            set(gh.mfe_panel_markeredgecolour_popupmenu,'Value',...
                find(strcmpi(lineMarkerEdgeColor,...
                lineMarkerEdgeColorPopupmenuValues)));
            switch lineMarkerEdgeColor
                case 'none'
                    set(gh.mfe_panel_markeredgecoloursample_text,...
        ...
        lineMarkerFaceColorPopupmenuValues = ...
            cellstr(get(gh.mfe_panel_markerfacecolour_popupmenu,'String'));
        if ischar(lineMarkerFaceColor) && length(lineMarkerFaceColor)>1
            set(gh.mfe_panel_markerfacecolour_popupmenu,'Value',...
                find(strcmpi(lineMarkerFaceColor,...
                lineMarkerFaceColorPopupmenuValues)));
            switch lineMarkerFaceColor
                case 'none'
                    set(gh.mfe_panel_markerfacecoloursample_text,...
                        'BackgroundColor',get(mainWindow,'Color'))
                case 'auto'
                    set(gh.mfe_panel_markerfacecoloursample_text,...
        ...
        set(gh.mfe_panel_markersize_edit,'String',...
