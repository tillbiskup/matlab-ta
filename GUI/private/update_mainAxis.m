...
%             xLimits = [ad.control.axis.limits.x.min-.5 ...
%                 ad.control.axis.limits.x.max+.5];
%         else
...
%             yLimits = [ad.control.axis.limits.y.min-.5 ...
%                 ad.control.axis.limits.y.max+.5];
%         else
    ...
    case '1D along x' % time profile
        ...
        if ad.control.axis.onlyActive
            ...
            if (ad.data{k}.display.smoothing.x.value > 1)
                ...
                yMF = filterfun(yMF,ad.data{k}.display.smoothing.x.value);
            end
            ...
            if (ad.data{k}.display.scaling.z ~= 0)
                ...
                yMF = yMF * ad.data{k}.display.scaling.z;
            end
            switch ad.control.axis.MFEdisplay
                case 'MFoff'
                ...
                case 'MFoff+MFon'
                    if ad.control.axis.stdev && isfield(ad.data{k},'avg') ...
                        ...
                        errorbar(...
                            ...
                            x,...
                            yMF,...
                            ad.data{k}.avg.stdev.MFon,...
                            'Color',ad.data{k}.display.MFon.line.color,...
                            'LineStyle',ad.data{k}.display.MFon.line.style,...
                            'Marker',ad.data{k}.display.MFon.line.marker.type,...
                            'MarkerEdgeColor',ad.data{k}.MFon.line.marker.edgeColor,...
                            'MarkerFaceColor',ad.data{k}.MFon.line.marker.faceColor,...
                            'MarkerSize',ad.data{k}.MFon.line.marker.size,...
                            'LineWidth',ad.data{k}.display.MFon.line.width...
                            );
                    else
                        plot(...
                            mainAxes,...
                ...
                case 'MFoff+MFon+DeltaMF'
                    if ad.control.axis.stdev && isfield(ad.data{k},'avg') ...
                        ...
                        errorbar(...
                            ...
                            x,...
                            yMF-y,...
                            ad.data{k}.avg.stdev.DeltaMF,...
                            'Color',ad.data{k}.display.DeltaMF.line.color,...
                            'LineStyle',ad.data{k}.display.DeltaMF.line.style,...
                            'Marker',ad.data{k}.display.DeltaMF.line.marker.type,...
                            'MarkerEdgeColor',ad.data{k}.display.DeltaMF.line.marker.edgeColor,...
                            'MarkerFaceColor',ad.data{k}.display.DeltaMF.line.marker.faceColor,...
                            'MarkerSize',ad.data{k}.display.DeltaMF.line.marker.size,...
                            'LineWidth',ad.data{k}.display.DeltaMF.line.width...
                            );
                    else
                        plot(...
                            mainAxes,...
                        ...
                        plot(...
                            ...
                            'LineStyle',ad.data{k}.display.MFon.line.style,...
                            'Marker',ad.data{k}.display.MFon.line.marker.type,...
                            'MarkerEdgeColor',ad.data{k}.display.MFon.line.marker.edgeColor,...
                            'MarkerFaceColor',ad.data{k}.display.MFon.line.marker.faceColor,...
                            'MarkerSize',ad.data{k}.display.MFon.line.marker.size,...
                            'LineWidth',ad.data{k}.display.MFon.line.width...
                            );
                        plot(...
                            mainAxes,...
    ...
    case '1D along y' % B0 spectrum
        ...
        if ad.control.axis.onlyActive
            ...
            if (ad.data{k}.display.displacement.z ~= 0)
                ...
                xMF = xMF + ad.data{k}.display.displacement.z;
            end
            % Apply thresholds
            if ad.data{k}.display.threshold.min.enable
                x(x<ad.data{k}.display.threshold.min.value) = ...
                    ad.data{k}.display.threshold.min.value;
                xMF(xMF<ad.data{k}.display.threshold.min.value) = ...
                    ad.data{k}.display.threshold.min.value;
            end
            if ad.data{k}.display.threshold.max.enable
                x(x>ad.data{k}.display.threshold.max.value) = ...
                    ad.data{k}.display.threshold.max.value;
                xMF(xMF>ad.data{k}.display.threshold.max.value) = ...
                    ad.data{k}.display.threshold.max.value;
            end
            % Normalise if necessary
            switch ad.control.axis.normalisation
            ...
            if (ad.data{k}.display.smoothing.y.value > 1)
                ...
                xMF = filterfun(xMF,ad.data{k}.display.smoothing.y.value);
            end
            % Apply scaling if necessary
            ...
            if (ad.data{k}.display.scaling.z ~= 0)
                ...
                xMF = xMF * ad.data{k}.display.scaling.z;
            end
            switch ad.control.axis.MFEdisplay
                case 'MFoff'
                    if ad.control.axis.stdev && isfield(ad.data{k},'avg') ...
