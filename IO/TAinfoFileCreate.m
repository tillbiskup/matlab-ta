function [fileContents,warnings] = TAinfoFileCreate(parameters,varargin)
% TAINFOFILECREATE Create Info files of TA spectra. To write the returned
...
try
    ...
    % fields
    if ~isempty(parameters.parameters.date.start)
    ...
    if ~isempty(parameters.parameters.date.end)
